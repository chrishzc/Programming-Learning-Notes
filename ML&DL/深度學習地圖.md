...
「深度學習 DL」系列筆記目前共有 16 篇，涵蓋了深度學習核心領域，建議讀者按照以下六個階段進行學習：
...
- **[[深度學習 DL/12.GoogLeNet網路.md|12. GoogLeNet 網路]]**：解析並聯 Inception 模組與全域平均池化（GAP）。
- **[[深度學習 DL/13.ResNet網路.md|13. ResNet 網路]]**：深入殘差連接（Residual Block），解決深層網路退化問題。

### 階段 5：預訓練與遷移學習
- **[[深度學習 DL/16.預訓練模型、遷移學習.md|16. 預訓練模型與遷移學習]]**：如何利用在大規模數據（ImageNet）上訓練好的特徵進行遷移學習與微調。

### 階段 6：循環神經網路 (RNN) 與自然語言處理 (NLP)
- **[[深度學習 DL/11.Ｗord representation介紹與Word Embedding實作.md|11. Word Representation & Embedding]]**：文字如何向量化（One-hot vs. Embedding）。
- **[[深度學習 DL/14.RNN網路介紹.md|14. RNN 介紹]]**：序列數據的時間循環與展開、SimpleRNN 實作。
- **[[深度學習 DL/15.LSTM 介紹.md|15. LSTM 介紹]]**：深入遺忘門、輸入門、輸出門，徹底解決長序列梯度消失。
